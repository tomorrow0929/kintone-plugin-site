  ...
  .schema({
    Plugin: a
      .model({
        ...
        // ダウンロード数。incrementDownloadCount（下）から更新される。
     ...
     *
     * 訪問者に Plugin の更新権限を与えたくないので、Lambda を経由させる。
     * Lambda 側は AppSync 経由でレコードを更新する（allow.resource で許可）。
     */
